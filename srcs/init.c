...
/*   Updated: 2017/09/19 17:36:31 by vmercadi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_base(t_base *base, char *av)
{
	...
	mlx_string_put(base->mx.mlx, base->mx.win, base->winx / 2, base->winy / 2, 0xffffff, "PLEASE WAIT...");
}
